...
//    public static final RegistrySupplier<Item> CORALSTONE_VERTICAL_SLAB_ITEM = conditionallyRegisterItem("coralstone_vertical_slab", () -> new BlockItem(CORALSTONE_VERTICAL_SLAB.get(), new Item.Properties().group(ItemGroup.BUILDING_BLOCKS)), () -> isLoaded("quark"));
    ...
    public static final RegistrySupplier<Block> POLISHED_CORALSTONE = create("polished_coralstone", () -> new Block(Block.Properties.of(Material.STONE, MaterialColor.COLOR_PURPLE).sound(SoundType.STONE).strength(1.5F, 1F).requiresCorrectToolForDrops()), CreativeModeTabs.BUILDING_BLOCKS); //Tool PICKAXE
...
//    public static final RegistrySupplier<Item> POLISHED_CORALSTONE_VERTICAL_SLAB_ITEM = conditionallyRegisterItem("polished_coralstone_vertical_slab", () -> new BlockItem(POLISHED_CORALSTONE_VERTICAL_SLAB.get(), new Item.Properties().group(ItemGroup.BUILDING_BLOCKS)), () -> isLoaded("quark"));
    ...
    public static final RegistrySupplier<Block> ALGAE_GRASS = create("algae_grass", () -> new AlgaeGrassBlock(Block.Properties.of(Material.GRASS, MaterialColor.COLOR_LIGHT_GREEN).sound(SoundType.WET_GRASS).strength(1F, 1F)), CreativeModeTabs.BUILDING_BLOCKS); //Tool SHOVEL not required tho
    public static final RegistrySupplier<Block> ALGAE_BLOCK = create("algae_block", () -> new Block(Block.Properties.of(Material.WOOL, MaterialColor.COLOR_LIGHT_GREEN).sound(SoundType.WET_GRASS).strength(1F, 1F)), CreativeModeTabs.BUILDING_BLOCKS);

    public static final RegistrySupplier<Block> PATTY_TILES = create("patty_tiles", () -> new Block(Block.Properties.of(Material.WOOL, MaterialColor.TERRACOTTA_ORANGE).sound(SoundType.STEM).strength(1F, 1F)), CreativeModeTabs.BUILDING_BLOCKS); //Tool SHOVEL not required tho

    public static final RegistrySupplier<Block> BAMBOO_WALL = create("bamboo_wall", () -> new RotatedPillarBlock(Block.Properties.copy(Blocks.BAMBOO)), CreativeModeTabs.BUILDING_BLOCKS);
    public static final RegistrySupplier<Block> PINK_BAMBOO_WALL = create("pink_bamboo_wall", () -> new RotatedPillarBlock(Block.Properties.copy(Blocks.BAMBOO)), CreativeModeTabs.BUILDING_BLOCKS);
    public static final RegistrySupplier<Block> BLUE_BAMBOO_WALL = create("blue_bamboo_wall", () -> new RotatedPillarBlock(Block.Properties.copy(Blocks.BAMBOO)), CreativeModeTabs.BUILDING_BLOCKS);
    public static final RegistrySupplier<Block> YELLOW_BAMBOO_WALL = create("yellow_bamboo_wall", () -> new RotatedPillarBlock(Block.Properties.copy(Blocks.BAMBOO)), CreativeModeTabs.BUILDING_BLOCKS);


    public static final RegistrySupplier<Block> WHITE_CARPETED_TILES = create("white_carpeted_tiles", () -> new Block(Block.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_WHITE).strength(2.0F, 3.0F).sound(SoundType.WOOL)), CreativeModeTabs.BUILDING_BLOCKS);
    public static final RegistrySupplier<Block> ORANGE_CARPETED_TILES = create("orange_carpeted_tiles", () -> new Block(Block.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_ORANGE).strength(2.0F, 3.0F).sound(SoundType.WOOL)), CreativeModeTabs.BUILDING_BLOCKS);
    public static final RegistrySupplier<Block> MAGENTA_CARPETED_TILES = create("magenta_carpeted_tiles", () -> new Block(Block.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_MAGENTA).strength(2.0F, 3.0F).sound(SoundType.WOOL)), CreativeModeTabs.BUILDING_BLOCKS);
    public static final RegistrySupplier<Block> LIGHT_BLUE_CARPETED_TILES = create("light_blue_carpeted_tiles", () -> new Block(Block.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_LIGHT_BLUE).strength(2.0F, 3.0F).sound(SoundType.WOOL)), CreativeModeTabs.BUILDING_BLOCKS);
    public static final RegistrySupplier<Block> YELLOW_CARPETED_TILES = create("yellow_carpeted_tiles", () -> new Block(Block.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_YELLOW).strength(2.0F, 3.0F).sound(SoundType.WOOL)), CreativeModeTabs.BUILDING_BLOCKS);
    public static final RegistrySupplier<Block> LIME_CARPETED_TILES = create("lime_carpeted_tiles", () -> new Block(Block.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_LIGHT_GREEN).strength(2.0F, 3.0F).sound(SoundType.WOOL)), CreativeModeTabs.BUILDING_BLOCKS);
    public static final RegistrySupplier<Block> PINK_CARPETED_TILES = create("pink_carpeted_tiles", () -> new Block(Block.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_PINK).strength(2.0F, 3.0F).sound(SoundType.WOOL)), CreativeModeTabs.BUILDING_BLOCKS);
    public static final RegistrySupplier<Block> GRAY_CARPETED_TILES = create("gray_carpeted_tiles", () -> new Block(Block.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_GRAY).strength(2.0F, 3.0F).sound(SoundType.WOOL)), CreativeModeTabs.BUILDING_BLOCKS);
    public static final RegistrySupplier<Block> LIGHT_GRAY_CARPETED_TILES = create("light_gray_carpeted_tiles", () -> new Block(Block.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_LIGHT_GRAY).strength(2.0F, 3.0F).sound(SoundType.WOOL)), CreativeModeTabs.BUILDING_BLOCKS);
    public static final RegistrySupplier<Block> CYAN_CARPETED_TILES = create("cyan_carpeted_tiles", () -> new Block(Block.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_CYAN).strength(2.0F, 3.0F).sound(SoundType.WOOL)), CreativeModeTabs.BUILDING_BLOCKS);
    public static final RegistrySupplier<Block> PURPLE_CARPETED_TILES = create("purple_carpeted_tiles", () -> new Block(Block.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_PURPLE).strength(2.0F, 3.0F).sound(SoundType.WOOL)), CreativeModeTabs.BUILDING_BLOCKS);
    public static final RegistrySupplier<Block> BLUE_CARPETED_TILES = create("blue_carpeted_tiles", () -> new Block(Block.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_BLUE).strength(2.0F, 3.0F).sound(SoundType.WOOL)), CreativeModeTabs.BUILDING_BLOCKS);
    public static final RegistrySupplier<Block> BROWN_CARPETED_TILES = create("brown_carpeted_tiles", () -> new Block(Block.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_BROWN).strength(2.0F, 3.0F).sound(SoundType.WOOL)), CreativeModeTabs.BUILDING_BLOCKS);
    public static final RegistrySupplier<Block> GREEN_CARPETED_TILES = create("green_carpeted_tiles", () -> new Block(Block.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_GREEN).strength(2.0F, 3.0F).sound(SoundType.WOOL)), CreativeModeTabs.BUILDING_BLOCKS);
    public static final RegistrySupplier<Block> RED_CARPETED_TILES = create("red_carpeted_tiles", () -> new Block(Block.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_RED).strength(2.0F, 3.0F).sound(SoundType.WOOL)), CreativeModeTabs.BUILDING_BLOCKS);
    public static final RegistrySupplier<Block> BLACK_CARPETED_TILES = create("black_carpeted_tiles", () -> new Block(Block.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_BLACK).strength(2.0F, 3.0F).sound(SoundType.WOOL)), CreativeModeTabs.BUILDING_BLOCKS);
    ...
    public static final RegistrySupplier<Block> POTTED_PINEAPPLE = create("potted_pineapple", () -> new FlowerPotBlock(PINEAPPLE_PLANT.get(), Block.Properties.copy(Blocks.FLOWER_POT)), CreativeModeTabs.BUILDING_BLOCKS);
