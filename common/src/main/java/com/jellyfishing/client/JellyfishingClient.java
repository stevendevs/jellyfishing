...
public class JellyfishingClient {
    public static void onClientInit() {
        ...
        ArmorRenderer.register((matrices, vertexConsumers, stack, entity, slot, light, contextModel) -> {
            ...
            if (stack.getItem().equals(JellyfishingItems.AIR_SUIT_HELMET.get()))
            ...
            else if (stack.getItem().equals(JellyfishingItems.AIR_SUIT_CHESTPLATE.get()))
            ...
            else if (stack.getItem().equals(JellyfishingItems.AIR_SUIT_BOOTS.get()))
